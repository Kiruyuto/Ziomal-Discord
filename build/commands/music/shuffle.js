...
var colors_2 = __importDefault(require("../../assets/colors"));
exports.default = {
    names: ['shuffle'],
    aliases: ['shuf', 'mix'],
    category: 'Music',
                ...
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        if (!queue) {
                            return [2 /*return*/, new discord_js_1.default.MessageEmbed({
                                    description: ":warning: No queue for **".concat(message ? (_b = message.guild) === null || _b === void 0 ? void 0 : _b.name : (_c = slashCmd.guild) === null || _c === void 0 ? void 0 : _c.name, "** has been found"),
                                    color: "".concat(colors_1.default.embedDefault),
                                })];
                        }
                        queue.shuffle();
                        return [2 /*return*/, new discord_js_1.default.MessageEmbed({
                    ...
                    case 2:
                        ...
                        embedDev_1 = new discord_js_1.default.MessageEmbed({
                            ...
                            color: colors_2.default.embedDefault,
                        });
