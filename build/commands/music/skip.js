...
exports.default = {
    ...
    callback: function (_a) {
        var client = _a.client, message = _a.message, slashCmd = _a.interaction, member = _a.member, guild = _a.guild, channel = _a.channel;
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        if (((_b = guild === null || guild === void 0 ? void 0 : guild.me) === null || _b === void 0 ? void 0 : _b.voice.channel) && ((_c = member.voice.channel) === null || _c === void 0 ? void 0 : _c.id) !== ((_e = (_d = guild === null || guild === void 0 ? void 0 : guild.me) === null || _d === void 0 ? void 0 : _d.voice.channel) === null || _e === void 0 ? void 0 : _e.id)) {
                    ...
                    case 2:
                        ...
                        embedDev_1 = new discord_js_1.default.MessageEmbed({
                            description: ":x: Something went wrong with `skip` command in the **".concat(guild, "** `(").concat(guild === null || guild === void 0 ? void 0 : guild.id, "})` sever!"),
                            color: colors_1.default.embedDefault,
                        });
